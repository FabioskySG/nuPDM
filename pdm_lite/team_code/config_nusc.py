...
class GlobalConfigNusc:
    ...
    def __init__(self):
        ...
        self.data_save_freq = 10 # I want to save each 2 Hz as nuScenes(less data)
        # º compression parameters
        self.point_format = 0  # LARS point format used for storing
        self.point_format_semantic = 0  # LARS point format used for storing
        ...
        self.cameras_height = 900  # Camera height in pixel during data collection
        self.cameras_fov = 70
