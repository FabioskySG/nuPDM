...
sensors_to_icons = {
    ...
    'sensor.lidar.ray_cast_semantic':    'carla_lidar_semantic',
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            if int(os.environ.get('DATAGEN', 0))==1:
                print("\033[1m> Generating data\033[0m")
                self.agent_instance = agent_class_obj(args.agent_config, config.index)
            else:
                print("\033[1m> Running the agent without data generation\033[0m")
...
def main():
    ...
    print("\n\033[1m> Running the leaderboard with the following arguments:\033[0m")
